...
ins = "INSERT INTO input_tb(Roll,FName,LName) VALUES(%s,%s,%s)"
dis = "SELECT * FROM input_tb"
update = "UPDATE input_tb SET FName = %s WHERE Roll = %s "
updatel = "UPDATE input_tb SET LName = %s WHERE Roll = %s "
delete = "DELETE FROM input_tb WHERE Roll = %s"
search = "SELECT * FROM input_tb where Roll= %s "


class Student_t():
    def __init__(self):
        self.root = Tk()
        # differecnc 500x330 & 400x200+100+200
        self.root.geometry('300x300+500+200')
        self.root.title("Stu_MS")

    def gmetry(self):
        self.branch = Tk()
        self.branch.geometry('350x300+520+200')
        self.branch.title("Stu_MS")

    def Stu_Interface(self):
        ...
        xit = partial(self.xit, self.root)
        self.bttn1 = Button(self.root, text="INSERT", command=self.Insert_Interface,font='Verdana 12').grid(row=3, column=4)
        self.bttn2 = Button(self.root, text="SHOW", command=self.showdata,font='Verdana 12').grid(row=4, column=4)
        self.bttn2 = Button(self.root, text="SEARCH", command=self.Search_Interface,font='Verdana 12').grid(row=5, column=4)
        self.bttn2 = Button(self.root, text="UPDATE", command=self.Update_Interface,font='Verdana 12').grid(row=6, column=4)
        self.bttn2 = Button(self.root, text="DELETE", command=self.Delete_Interface_1,font='Verdana 12').grid(row=7, column=4)
        self.bttn2 = Button(self.root, text="EXIT", command=xit,font='Verdana 12').grid(row=8, column=4)
        self.root.mainloop()
    ...
    def show_Interface(self):
        ...
        trev=ttk.Treeview(show_frame,yscrollcommand=scrll.set,xscrollcommand=scrll.set)
        trev.pack()
        ...
        for i in range(self.l):
            trev.insert(parent='',index='end',iid=i,text='', values=self.a[i])
        trev.pack()
        xit = partial(self.xit, self.branch)
        self.bttn1 = Button(self.branch, text="EXIT", command=xit,
                            font='Verdana 12')
    ...
    def Search_Interface_2(self):
        ...
        self.labNum1 = Label(self.branch, text="Roll No.",font='Verdana 12').grid(row=1, column=0)
        self.labNum2 = Label(self.branch, text="First Name",font='Verdana 12').grid(row=2, column=0)
        self.labNum3 = Label(self.branch, text="Last Name",font='Verdana 12').grid(row=3, column=0)
        self.entryRoll = Entry(self.branch,width=20,font=('Arial'),disabledbackground='grey')
        ...
        xit = partial(self.xit, self.branch)
        self.bttn1 = Button(self.branch, text="EXIT", command=xit,font='Verdana 10').grid(row=6, column=1)
        conn.commit()
        self.branch.mainloop()
    ...
    def Update_Interface_2(self):
        ...
        self.mssglab.grid(row=7,column=1)
        xit = partial(self.xit, self.branch)
        updata=partial(self.updata,self.mssglab)
        self.bttn = Button(self.branch, text="ENTER",command=updata, font='Verdana 10').grid(row=5, column=1)
        self.bttn1 = Button(self.branch, text="EXIT", command=xit,font='Verdana 10').grid(row=6, column=1)
        self.branch.mainloop()

    def updata(self,label):
        fname=(self.entryFname.get())
        lname=(self.entryLname.get())
        mycursor.execute(update,(fname,self.x))
        mycursor.execute(updatel,(lname,self.x))
        conn.commit()
    ...
    def Delete_Interface_2(self):
        ...
        self.x=self.entryRoll.get()
        self.x=int(self.x)
        mycursor.execute("SELECT * FROM input_tb where Roll=%s",(self.x,))
        self.dt=mycursor.fetchone()
        self.labNum1 = Label(self.branch, text="Roll No.",font='Verdana 12').grid(row=1, column=0)
        self.labNum2 = Label(self.branch, text="First Name",font='Verdana 12').grid(row=2, column=0)
        self.labNum3 = Label(self.branch, text="Last Name",font='Verdana 12').grid(row=3, column=0)
        ...
        self.mssglab.grid(row=7,column=1)
        xit = partial(self.xit, self.branch)
        del_data=partial(self.del_data,self.mssglab)
        self.bttn = Button(self.branch, text="DELETE",command=del_data, font='Verdana 10').grid(row=5, column=1)
        self.bttn1 = Button(self.branch, text="EXIT", command=xit,font='Verdana 10').grid(row=6, column=1)
        self.branch.mainloop()

    def del_data(self,label):
